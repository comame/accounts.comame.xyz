...
export function Modal({ open, children, isDissmissable = true}: props) {
    ...
    return open[0] ? <>
        <div
            className='w-screen h-screen bg-surface4 z-10 fixed top-0 left-0 flex justify-center items-center'
            onClick={ onBackgroundClick }
        >
            <div className='bg-background1 w-col-span-4 p-24 rounded-24 relative'>
                { children }
